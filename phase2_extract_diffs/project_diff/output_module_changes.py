from phase2_extract_diffs.project_diff.constant import old_base_dir, new_base_dir
from phase2_extract_diffs.project_diff.file_diff import build_file_path, output_file_diff_with_file_name
