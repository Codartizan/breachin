from phase2_extract_diffs1.project_diff.file_diff import output_file_diff_with_file_name
...
if __name__ == '__main__':
    ...
    with open(r'/phase2_extract_diffs1/output/remained_diff.txt', 'w') as fp:
        diffs = []
